...
def swine_align(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4a
    "*** YOUR CODE HERE ***"
    strider_score = player_score
    if player_score == 0 or opponent_score == 0 :
        return False
    else :
        while player_score :
            if opponent_score % player_score == 0 and strider_score % player_score == 0:
                if player_score >= 10:
                    return True
...
def pig_pass(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4b
    "*** YOUR CODE HERE ***"
    differentce_between =  opponent_score - player_score
    if differentce_between < 3 and differentce_between >0 :
        return True
    return False
    # END PROBLEM 4b
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 6
        "*** YOUR CODE HERE ***"
        this_is_a_start = 0
        if this_is_a_start == 0 :
            say = say(score0, score1)
        # else :
        #     this_is_a_start = this_is_a_start(score0, score1)
    # END PROBLEM 6
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    #     cnt = 0
    #     if who == 0 :
    #         if score0 - last_score > running_high :                   for running_high variable ,dont reference it before assignment
    #             # running_high = score0 - last_score                  you can simply use it in this way :
                                                                        # global RUNNING_HIGH
    #             print(score0 - last_score, 'point(s)! The most yet for Player 0')
    #             cnt = 1                               
    #         return announce_highest(who, score0, score0 - last_score if cnt == 1 else running_high)
    #     else :
    #         if score1 - last_score > running_high :
    #             # running_high = score1 - last_score
    #             print(score1 - last_score, 'point(s)! The most yet for Player 1')
    #             cnt == 1
    #         return announce_highest(who, score1, score1 - last_score if cnt ==1 else running_high)
    # return say
    def say(score0, score1):
        CNT = 0
        if (who == 0):
...
def extra_turn_strategy(score, opponent_score, cutoff=10, num_rolls=1):
